...
export const skillsTextA = [`I do my coding in the VS Code editor using Prettier, Colour Brackets and
...
ease of installing and integration in create-react-app.`, `These are the tools and technologies I use on a regular coding basis:`]

export const skillsTextB = [`Other technologies I use when I needed are MongoDB, Bootstrap, jQuery
...
configure Cisco routers and manage Windows Server and Window Active Directory.`, `I host Murder Mysteries and Trivia nights which has made me a confident public speaker.`]
